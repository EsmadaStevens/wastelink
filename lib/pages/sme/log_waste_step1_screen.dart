                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: const Color(0xFF005841), width: 2),
                            ),
                          ),
                        ),
                      ],
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Select the type of waste you're logging", style: TextStyle(color: Colors.grey.shade500)),
                  const SizedBox(height: 32),
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: isSelected ? const Color(0xFF005841) : Colors.grey.shade100,
                              width: 2,
                            ),
                          ),
                          child: Column(
                      ...
                      onPressed: _selectedType != null
                          ? () {
                              Navigator.pushNamed(
                                context,
                                '/log_waste_step2',
                                arguments: {'wasteType': _selectedType},
                              );
                            }
                          : null,
